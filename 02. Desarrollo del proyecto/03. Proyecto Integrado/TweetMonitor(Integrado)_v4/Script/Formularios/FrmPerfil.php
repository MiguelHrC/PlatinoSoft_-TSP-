    ...
    <div class="row">
        <fieldset class="col-xs-8 col-xs-offset-1">
            ...
            <form method="POST" action="./FrmPerfil.php" class="form-horizontal">
                ...
                <div class="form-group">
                    <label class="col-xs-12 col-xs-offset-1" for="Contrasena">
                        <h4>Contraseña:</h4>
                    </label>
                    <div class="col-xs-8 col-xs-offset-1">
                        ...
                        <div class="col-xs-8 col-xs-offset-3">
                            <div class="form-group">
                                <div class="input-group">
                                    ...
                                    <p></p><a href="./FrmItinerario.php" class="btn btn-danger" name="Cancelar" value="Cancelar"><span>Cancelar</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
